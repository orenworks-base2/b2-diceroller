...
function renderFilter( $type, $column = [] ) {
    ...
    switch( $type ) {
        ...
        case 'select':
            ...
            break;
        case 'range':
            $html = '<div class="input_range_home list-inline">
                        <div class="input_range_div1 list-inline-item">
                            <span class="span_range_placeholder"> ' . $column->placeholder . ' </span>
                        </div>
                        <div class="input_range_div2 list-inline-item">
                            <div class="list-inline div_filter_range">
                                <span class="span_range list-inline-item"> From </span>
                                <input type="text" class="input_range list-inline-item" id="min_' . $column->id . '" data-id="min_' . $column->id . '">
                                <span class="span_range list-inline-item"> To </span>
                                <input type="text" class="input_range list-inline-item" id="max_' . $column->id . '" data-id="max_' . $column->id . '">
                            </div>
                        </div>
                    </div>';
            break;
